import { TAB_MENU_CLASSES } from '../constants/classNames';
...
// 활성 상태 클래스 이름
const activeClass = TAB_MENU_CLASSES.active;

// DOM 객체 참조 변수
let newsTabMenu = null;
let newsContents = [];
...
function render(visibleSelector) {
  ...
  // 화면에 표시할 문서 객체 참조
  const visibleContent = document.querySelector(visibleSelector);
